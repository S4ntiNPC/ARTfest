...
// Generación de rutas estáticas (Obligatorio para exportación estática)
...
// --- CAMBIO IMPORTANTE PARA NEXT.JS 15 ---
...
export default async function EventDetailPage({ params }: PageProps) {
  // 1. Desempaquetamos los params usando await (Requisito de Next.js 15)
    ...
    <div className="min-h-screen bg-black pb-10">
      ...
      <div className={`relative h-48 w-full ${headerColor}`}>
        ...
        <div className="container mx-auto px-4 h-full flex flex-col justify-end pb-6 relative z-10">
          <Link 
            href="/"
            className="absolute top-4 left-4 inline-flex items-center gap-2 rounded-full bg-black/40 px-4 py-2 text-sm font-medium text-white backdrop-blur-md hover:bg-black/60 transition-colors"
          >
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  {event.facilitator.instagramUrl && (
                    <a 
                      href={event.facilitator.instagramUrl}
                      target="_blank"
                      className="mt-3 inline-flex items-center gap-2 text-sm font-semibold text-pink-500 hover:text-pink-400"
                    >
